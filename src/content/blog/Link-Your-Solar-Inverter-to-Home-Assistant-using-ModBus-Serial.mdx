...
* **[ESP8266](https://amzn.to/42OCSLV)** or **[ESP32](https://amzn.to/4hr0oDg)**: Low-cost Wi-Fi microchips with built-in TCP/IP protocol stack.
...
* **[RJ45](https://amzn.to/42Kbwq8)**: A type of connector commonly used for Ethernet networking.
...
* **[ESP8266](https://amzn.to/42OCSLV) or [ESP32](https://amzn.to/4hr0oDg)**
* **RS485 board to use with ESP8266 (recommended: [MAX485 TTL](https://amzn.to/4gwYakD))**
* **A spare [ethernet cable ](https://amzn.to/4huonl8)for the RJ45.**

## Debugging

**Before proceeding**, verify that you can get MODBUS serial to work with your inverter. I used a [USB RS485 board](https://amzn.to/412EHnf) for easy debugging with a trial of [Modbus Poll](https://www.modbustools.com/download.html "Modbus Poll"). I have wasted a lot of time starting directly on the [ESP8266](https://amzn.to/42OCSLV) instead of starting with some isolated testing.

## Hardware Setup

For this solution, I used an [ESP8266](https://amzn.to/42OCSLV) with a [MAX485](https://amzn.to/4gwYakD). Alternatively, you can use a UART TTL to RS485 board with automatic flow control, although I found the more reliable. Setting up flow control on an ESPHome installation is just setting one configuration value.
...
* **[ESP8266](https://amzn.to/42OCSLV) to [MAX485](https://amzn.to/4gwYakD)**
